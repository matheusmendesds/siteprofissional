...
export default function Menu(){
    return (
        <header class="bg-white border border-x-transparent">
                <div class="mx-auto flex h-16 max-w-7xl items-center gap-8 px-4 sm:px-6 lg:px-8">
                    ...
                    <nav aria-label="Global">
                        ...
                        <li>
                            <Link class="text-gray-500 transition hover:text-gray-500/75" href="#sobre"> QUEM SOMOS </Link>
                        </li>

                        <li>
                            <Link class="text-gray-500 transition hover:text-gray-500/75" href="#servicos"> SERVIÇOS </Link>
                        </li>

                        <li>
                            <Link class="text-gray-500 transition hover:text-gray-500/75" href="#portfolio">PORTFÓLIO </Link>
                        </li>

                        <li>
                            <Link class="text-gray-500 transition hover:text-gray-500/75" href="#contato"> FALE CONOSCO </Link>
                        </li>
